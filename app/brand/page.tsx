...
const translations = {
  ...
  DE: {
    ...
    heroLabel: 'Brand-Website Case Study',
    heroText:
      'Eine atmosphaerische Restaurant-Website mit hochwertigem Look, interaktiver Speisekarte, Reservierungsflow, Social Proof und Inhalten, die direkt zu Buchungen fuehren.',
    bookTable: 'Tisch reservieren',
    exploreMenu: 'Speisekarte ansehen',
    tonight: 'Heute Abend',
    seasonalDinner: 'Saisonales Dinner',
    naturalWine: '18:00 - 23:00 · Kreuzberg · Naturweinbegleitung verfuegbar',
    nextAvailable: 'Naechster Slot',
    reservationFlow: 'Reservierungsflow',
    menuModes: 'Menue-Modi',
    guestRating: 'Gaestebewertung',
    responsive: 'responsive',
    experienceLabel: 'Erlebnis',
    experienceTitle: 'Jeder Abschnitt hat eine Aufgabe: Wunsch, Vertrauen, Entscheidung.',
    experienceCards: [
      ['Editorialer Hero', 'Grosse Fotografie und klare Texte machen die Marke sofort erinnerbar.'],
      ['Schnelle Buchung', 'Sticky CTA, Formular und freie Zeiten reduzieren Reibung fuer Gaeste.'],
      ['Speisekarten-Entdeckung', 'Kategorien lassen Dinner, Brunch und Wein direkt auf der Seite entdecken.'],
      ['Vertrauen', 'Reviews, Standort, Oeffnungszeiten und Social Proof unterstuetzen die Entscheidung.'],
    ],
    videoLabel: 'Atmosphaeren-Video',
    ...
    menuText:
      'Gaeste koennen zwischen Dinner, Wein, Brunch und Dessert wechseln. Jedes Gericht hat Bild, Preis und Kurzbeschreibung, wie in einem echten Restaurant-Produkt.',
    viewDish: 'Gericht ansehen',
    menuHighlights: [
      ['Chef-Auswahl', 'Saisonale Highlights werden woechentlich aktualisiert.'],
      ['Hinweise', 'Vegetarische und glutenfreie Optionen sind im Flow klar sichtbar.'],
      ['Conversion-Detail', 'Die Speisekarte fuehrt natuerlich zur Reservierung.'],
    ],
    reserveLabel: 'Reservieren',
    reserveTitle: 'Ein sauberer Buchungsflow, den Recruiter wirklich testen koennen.',
    address: 'Oranienstrasse 44, 10999 Berlin',
    hours: 'Di - Sa · 18:00 - 23:00',
    brunchHours: 'Brunch · Samstag und Sonntag · 10:00 - 15:00',
    slotsAvailable: 'freie Zeiten fuer das gewaehlte Datum',
    name: 'Name',
    ...
    fullyBooked: 'Ausgebucht fuer dieses Datum',
    fullyBookedHelp: 'Dieses Datum ist ausgebucht. Bitte waehle ein anderes Datum.',
    ...
    deposit: 'Deposit:',
    depositText: 'keine Vorauszahlung fuer Gruppen unter 6 Personen.',
    hold: 'Hold:',
    holdText: 'Tische werden 15 Minuten gehalten.',
    changes: 'Aenderungen:',
    changesText: 'fuer Aenderungen am selben Tag bitte anrufen.',
    requestReservation: 'Reservierung anfragen',
    bookingConfirmed: 'Reservierung bestaetigt',
    ...
    dietText: 'saisonal',
    pairing: 'Pairing:',
    pairingText: 'Wein verfuegbar',
    close: 'Schliessen',
    invalidPast: 'Bitte waehle heute oder ein zukuenftiges Datum.',
    invalidClosed: 'Maison Verde ist montags geschlossen. Bitte waehle ein anderes Datum.',
    invalidBrunch: 'Brunch ist nur samstags und sonntags verfuegbar.',
    invalidTime: 'Bitte waehle eine verfuegbare Zeit fuer diesen Service.',
    invalidBooked: 'Diese Zeit ist bereits reserviert. Bitte waehle einen freien Slot.',
    invalidForm: 'Bitte Name, Telefon, gueltige E-Mail mit @, Datum, Zeit und Gaestezahl ausfuellen.',
    reservationFound: 'Reservierung bestaetigt fuer',
    reservationNotFound: 'Reservierung nicht gefunden. Bitte Buchungs-ID und E-Mail pruefen.',
    reservationCancelled: 'Reservierung storniert. Der Zeitslot ist wieder verfuegbar.',
  },
}
...
export default function BrandWebsitePage() {
  ...
  const guestLabel = (guests: string) =>
    language === 'DE' ? guests.replace('guests', 'Gaeste') : guests
